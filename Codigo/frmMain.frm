...
Begin VB.Form FrmMain 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox txtMapZona 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "frmMain.frx":A001
         Left            =   840
         List            =   "frmMain.frx":A00E
         TabIndex        =   129
         Top             =   3960
         Width           =   1095
      End
      Begin VB.ComboBox txtMapTerreno 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "frmMain.frx":A02A
         Left            =   840
         List            =   "frmMain.frx":A037
         TabIndex        =   128
         Top             =   4320
         Width           =   1095
      End
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":11E36
         Left            =   3360
         List            =   "frmMain.frx":11E38
         TabIndex        =   73
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":11E3A
         Left            =   1080
         List            =   "frmMain.frx":11E4A
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":11E5A
         Left            =   840
         List            =   "frmMain.frx":11E5C
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":11E5E
         Left            =   840
         List            =   "frmMain.frx":11E60
         TabIndex        =   51
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":11E62
         Left            =   840
         List            =   "frmMain.frx":11E64
         TabIndex        =   70
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":11E66
         Left            =   3360
         List            =   "frmMain.frx":11E68
         TabIndex        =   60
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":11E6A
         Left            =   4440
         List            =   "frmMain.frx":11E6C
         Sorted          =   -1  'True
         TabIndex        =   72
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":11E6E
         Left            =   3360
         List            =   "frmMain.frx":11E70
         TabIndex        =   50
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":11E72
         Left            =   120
         List            =   "frmMain.frx":11E74
         Sorted          =   -1  'True
         TabIndex        =   64
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":11E76
         Left            =   120
         List            =   "frmMain.frx":11E78
         Sorted          =   -1  'True
         TabIndex        =   59
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":11E7A
         Left            =   120
         List            =   "frmMain.frx":11E7C
         Sorted          =   -1  'True
         TabIndex        =   48
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":11E7E
         Left            =   120
         List            =   "frmMain.frx":11E80
         TabIndex        =   47
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
...
Private Sub lblMapaActivo_Click()
    
    On Error GoTo lblMapaActivo_Click_Err
...
Private Sub MapPest_Click(Index As Integer)
    ...
    lblMapaActivo.Caption = MapaActual
